    ...
    <>
      ...
      >
        <div className="space-y-4">
          ...
          {/* ============================================================
              BAR ATAS MENU AKTIF: HANYA TOMBOL KEMBALI & IDENTITAS MENU INI
              ============================================================ */}
          {activeTab !== 'launchpad' && (
            <div className="flex items-center justify-between gap-3 pb-3 border-b border-slate-200/80">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 active:scale-95 transition-all cursor-pointer border border-slate-200 shrink-0"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                {activeTab === 'kasbon' && (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-extrabold bg-amber-100 text-amber-800 border border-amber-200">
                    <CreditCard className="w-4 h-4 text-amber-700" />
                    <span>Menu Kasbon</span>
                  </span>
                )}
                {activeTab === 'transaksi_rutin' && (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-extrabold bg-teal-100 text-teal-800 border border-teal-200">
                    <Receipt className="w-4 h-4 text-teal-700" />
                    <span>Menu Transaksi Rutin</span>
                  </span>
                )}
                {activeTab === 'transaksi_harian' && (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-extrabold bg-brand-100 text-brand-800 border border-brand-200">
                    <ReceiptText className="w-4 h-4 text-brand-700" />
                    <span>Menu Transaksi Harian</span>
                  </span>
                )}
              </div>
            </div>
